...
if (PlayerInput = "Enabled")		// Place all necessary turn or battle actions here. 
{
	/////////////////////
	//     MOVING      //
	/////////////////////
	...
	if(keyboard_check(vk_left)){				// moving left collisions
		...
		if(x < 30){								// the the player has moved off the edge of the screen
			x = 30
		}
		...
		//	image_speed = anim_speed;			// make sure the animations will play at correct speed
		//}
		if(x > 3970){						// the the player has moved off the edge of the screen (only works for this map)
			x=3970
		}
